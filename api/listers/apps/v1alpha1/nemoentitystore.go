...
type NemoEntitystoreLister interface {
	...
	List(selector labels.Selector) (ret []*appsv1alpha1.NemoEntitystore, err error)
...
type nemoEntitystoreLister struct {
	listers.ResourceIndexer[*appsv1alpha1.NemoEntitystore]
}
...
func NewNemoEntitystoreLister(indexer cache.Indexer) NemoEntitystoreLister {
	return &nemoEntitystoreLister{listers.New[*appsv1alpha1.NemoEntitystore](indexer, appsv1alpha1.Resource("nemoentitystore"))}
}

// NemoEntitystores returns an object that can list and get NemoEntitystores.
func (s *nemoEntitystoreLister) NemoEntitystores(namespace string) NemoEntitystoreNamespaceLister {
	return nemoEntitystoreNamespaceLister{listers.NewNamespaced[*appsv1alpha1.NemoEntitystore](s.ResourceIndexer, namespace)}
}
...
type NemoEntitystoreNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*appsv1alpha1.NemoEntitystore, error)
