...
func (c *V1alpha1Client) NIMCaches(namespace string) NIMCacheInterface {
	return newNIMCaches(c, namespace)
}

func (c *V1alpha1Client) NIMPipelines(namespace string) NIMPipelineInterface {
	return newNIMPipelines(c, namespace)
}

func (c *V1alpha1Client) NIMServices(namespace string) NIMServiceInterface {
